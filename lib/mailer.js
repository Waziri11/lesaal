...
export async function sendCampaignNotification({ submissionData }) {
  if (!isMailConfigured()) {
  ...
  await transporter.sendMail({
    ...
    text: `A new campaign form submission has been received:\n\n${rows}`,
    html: `<p>A new campaign form submission has been received:</p><ul>${htmlRows}</ul>`,
  });
