...
const DEFAULT_HERO_IMAGE = "/images/services/social-media-management.jpg";
const DEFAULT_COMMENTARY_IMAGE = "/images/services/content-creation.jpg";
...
function buildDefaultServices() {
  return [
    ...
    },
    {
      ...
      imageUrl: "/images/services/seo-optimization.jpg",
      label: "Search",
      value: "Visibility",
    ...
    },
    {
      ...
      imageUrl: "/images/services/ppc-advertising.jpg",
      label: "Paid Media",
      value: "Conversions",
    ...
    },
    {
      ...
      imageUrl: "/images/services/email-marketing.jpg",
      label: "Retention",
      value: "Lifecycle",
    ...
    },
    {
      ...
      imageUrl: "/images/services/lead-generation.jpg",
      label: "Pipeline",
      value: "Demand",
    ...
    },
    {
      ...
      imageUrl: "/images/services/marketing-automation.jpg",
      label: "Systems",
      value: "Scale",
    ...
    },
    {
      ...
      imageUrl: "/images/services/analytics-reporting.jpg",
      label: "Insights",
      value: "Performance",
...
export function getDefaultLandingSections() {
  return [
    ...
    },
    {
      ...
      scrollAnimation: "REVEAL",
      settings: {
        heading: "Ready to launch your next campaign?",
        subheading: "Share your goals and our team will reach out with a recommended growth plan.",
        submitText: "Submit Campaign Request",
        successMessage: "Thank you. Your campaign request has been received.",
      },
      items: [],
    },
    {
      ...
      items: [
        ...
        { title: "Contact", label: "Support", description: "", value: "mailto:leilawaziri@lesaal.com", order: 3 },
      ],
    },
  ];
}
